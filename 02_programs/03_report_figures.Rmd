...
ar_oz_adj_diff <- ar_oz %>% 
  ...
  group_by(GEOID_b, arrest_month_yr, DESIGNATED, pct_white, pct_higher_ed, pct_rent, pct_native_hc_covered,
...
```
```{r}
modeldata <- cbind(ar_oz_adj_diff[rownames(lmviolentarrest$model), ], "resid_violent" = lmviolentarrest$residuals,
