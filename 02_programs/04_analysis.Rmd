...
output %>%
  ...
  pivot_wider(
    id_cols = c("quarter", "order", "covs", "cutoff"), names_from = c("crime_type", "term", "arrest_or_complaint"),
    values_from = "coef_form"
  ) %>%
  select(c("quarter", "order", "covs", "cutoff"), matches("Conventional"), matches("Bias"), matches("Robust")) %>%
  select(c("quarter", "order", "covs", "cutoff"), matches("property"), matches("violent")) %>%
