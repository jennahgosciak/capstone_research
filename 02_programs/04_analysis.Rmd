...
>>>>>>> 272b82283c430bd0dcd2b2b76dcce8d78b2ceee4
```
...
```{r}
walk2(c(1, 4), c(400), ~ generate_rd_plot(analysis_file, "violent_ellen_winsorize_ar_0", "Violent crime arrests, quarter 0", .x, 
                                          constructs, "arrests", "quarter", h = .y))

walk2(c(1, 4), c(400), ~ generate_rd_plot(analysis_file, "property_ellen_winsorize_ar_0", "Property crime arrests, quarter 0", .x,
                                          constructs, "arrests", "quarter", h=.y))

walk2(c(1, 4), c(400), ~ generate_rd_plot(analysis_file, "violent_ellen_winsorize_ar_4", "Violent crime arrests, quarter 4", .x, 
                                          constructs, "arrests", "quarter", h = .y))

walk2(c(1, 4), c(400), ~ generate_rd_plot(analysis_file, "property_ellen_winsorize_ar_4", "Property crime arrests, quarter 4", .x,
                                          constructs, "arrests", "quarter", h=.y))
```
```{r}
