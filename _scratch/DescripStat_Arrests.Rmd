...
ar_oz <- ar_oz %>%   mutate(misdemeanor = ifelse(law_cat_cd == "M", 1, 0)) %>% 
  ...
  #mutate(property = ifelse(ofns_desc == "GRAND LARCENY" | ofns_desc == "PETIT LARCENY" | ofns_desc == "GRAND LARCENY OF MOTOR VEHICLE" | ofns_desc == "BURGLARY" | ofns_desc == "BURGLAR'S TOOLS" | ofns_desc == "POSSESSION OF STOLEN PROPERTY 5" | ofns_desc == "UNAUTHORIZED USE OF A VEHICLE 3 (UUV)" | ofns_desc == "OTHER OFFENSES RELATED TO THEFT" | ofns_desc == "POSSESSION OF STOLEN PROPERTY", 1, 0)) %>% 
  #mutate(violent = ifelse(ofns_desc == "HOMICIDE-NEGLIGENT-VEHICLE" | ofns_desc == "HOMICIDE-NEGLIGENT,UNCLASSIFIED" | ofns_desc == "RAPE" | ofns_desc == "ROBBERY" | ofns_desc == "ARSON" | ofns_desc == "FELONY ASSAULT" | ofns_desc == "KIDNAPPING & RELATED OFFENSES" | ofns_desc == "MURDER & NON-NEGL. MANSLAUGHTER" | ofns_desc == "MURDER & NON-NEGL. MANSLAUGHTE" | ofns_desc == "ASSAULT 3 & RELATED OFFENSES", 1, 0))
  mutate(propertyny = ifelse(ofns_desc == "GRAND LARCENY" | ofns_desc == "PETIT LARCENY" | ofns_desc == "GRAND LARCENY OF MOTOR VEHICLE" | ofns_desc == "BURGLARY", 1, 0)) %>% 
  mutate(violentny = ifelse(ofns_desc == "RAPE" | ofns_desc == "ROBBERY" | ofns_desc == "FELONY ASSAULT" | ofns_desc == "MURDER & NON-NEGL. MANSLAUGHTER" | ofns_desc == "MURDER & NON-NEGL. MANSLAUGHTE", 1, 0))
